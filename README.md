...
**[Awesome books ES6]** is a simple website that allows you to add and remove books from a list it displays on a separate section of the single page web application.
...
- **[This project uses HTML, CSS and JavaScript linters]**
- **[Navigation between 3 sections using javascript]**
...
[ES6 Awesome books - Live Demo](https://clintonyounge.github.io/ES6-Awesome-Books/)
...
I would like to thanks Microverse for teaching me all I know about programming.
